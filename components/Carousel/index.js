    ...
    return (
      <div className="carousel">
        ...
        <a className="carousel-item">
          ...
          >
            Les TPE du BTP ont été invitées à participer à un petit
            déjeuner autour de la performance de leur entreprise et de
            comment garder ses salariés en bonne santé. 8 TPE étaient
            présentes autour de PÔLE SANTÉ TRAVAIL, de l’OPPBTP et
            du SAMETH pour échanger ensemble sur ces thématiques.
          </ImageCard>
        </a>
        <a className="carousel-item">
          <ImageCard
          ...
          >
            PÔLE SANTÉ TRAVAIL a été partenaire du Congrès des
            internes. Des supports ont été spécialement crées pour
            cette cible privilégiée. Les Ressources Humaines ont pu
            rencontrer et échanger de manière privilégiée avec les
            futurs médecins du travail. PÔLE SANTÉ TRAVAIL en tant
            que médecins collaborateurs.
          </ImageCard>
        </a>
        <a className="carousel-item">
          <ImageCard
          ...
          >
            PÔLE SANTÉ TRAVAIL a profité de l’assemblée générale
            pour proposer un retour juridique sur la loi travail. Plus de 40
            entreprises étaient présentes sur ce temps fort. Un second
            temps a été réservé aux administrateurs et à l’interne pour
            travailler sur le projet PÔLE SANTÉ TRAVAIL 2030.
          </ImageCard>
        </a>
        <a className="carousel-item">
          <ImageCard
          ...
          >
            Maintien dans l’emploi, loi travail et les missions du service
            de santé au travail ont été les 3 thématiques d’intervention
            proposées cette année. 30 entreprises participent à ces
        ...
        <a className="carousel-item">
          ...
          >
            ...
            privilégiée du service afin d’augmenter notre visibilité auprès

            des TPE. EXPOLE est le rendez-vous annuel des experts-
            comptables. En équipe avec le CEDEST et l’ASTIL62, nous

            avons informé plus de 55 contacts sur notre activité et
            proposé des partenariats privilégiés.
          </ImageCard>
        </a>
        <a className="carousel-item">
          <ImageCard
          ...
          >
            CRÉER en Nord-Pas de Calais est un salon régional qui
            se tient chaque année à Lille Grand Palais pour aider les
            créateurs d’entreprise et les jeunes TPE. Nous avons
            accueilli sur le stand 120 visiteurs qualifiés.
            </ImageCard>
        </a>
        <a className="carousel-item">
          <ImageCard
          ...
          >
            ...
            d’information dédié aux agences d’emplois en lien avec le
            service juridique et le Dr LEROYER. Près de 15 Agences
            d’emplois ont participé à cette information.
          </ImageCard>
        </a>
        <a className="carousel-item">
          <ImageCard
        ...
        <a className="carousel-item">
          ...
          >
            ...
            industriel et l’AFOMÉTRA pour leurs présentations
            respectives dans le cadre des journées du CISME : diaporama
            et clips vidéos ont été réalisés pour valoriser TOXILIST.fr et
            le e-learning.
            Bénéfice attendu : mutualisation des outils.
          </ImageCard>
        </a>
        <a className="carousel-item">
          <ImageCard
          ...
          >
            Le projet PÔLE SANTÉ TRAVAIL 2030 a débuté par le portrait
            culturel de notre association. Près de 100 personnes, salariés,
            administrateurs, partenaires et entreprises ont répondu aux
            sociologues du cabinet une ÎLE. Le portrait s’est poursuivi
            avec l’organisation de 3 tables rondes pluridisciplinaires qui
            ont mobilisé plus de 35 personnes.
          </ImageCard>
        </a>
        <a className="carousel-item">
          <ImageCard
          ...
          >
            En lien avec la relation adhérents, la rentrée sociale de
            l’URIOPPSS permet de mobiliser des contacts dans le
