          ...
          <div className="row">
            ...
            <div className="col s12 m4 offset-m1">
              ...
              <div className="partner">
                ...
                <p>
                  Aujourd’hui, toutes nos analyses passent par ce laboratoire à
                  la suite des prélévements effectués par nos équipes sur
            ...
            <div className="col s12 m5 offset-m2">
              ...
              <p>
                ...
                nouveau convoqué pour passer des examens prescrits par le
            ...
            <div className="col s12 m6 offset-m1">
              ...
              <p>
                ...
                métier exercé par le salarié les différentes expositions
                possibles (risques physiques, chimiques, biologiques,
                organisationnels...).
              </p>

              <p>
                Toutes les données seront tracées et ainsi conservées dans le
                dossier médical santé travail. L’équipe santé travail évalue
                ainsi le risque encouru par le salarié pour sa santé aujourd’hui
                mais aussi pour demain.
              </p>

              <p>
                Le curriculum laboris est confidentiel, il ne peut être transmis
                à l’employeur.
              </p>
            ...
            <div className="col s12 m6">
              <SimpleCard cardClass="colored">
                ...
                <ul className="card__list">
                  <li>
                    Éviter toute altération de la santé des travailleurs du fait
                    de leur travail, notamment en surveillant leurs conditions
                    d'hygiène au travail, les risques de contagion et leur état
                    de santé.
                  </li>
                  ...
                  <li>
                    ...
                    son action sur le milieu de travail, qu'il conduit avec les
                    autres membres de l'équipe pluridisciplinaire.
                  </li>

                  <li>
                    Contribuer à la veille épidémiologique en menant des études,
                    des enquêtes, en contribuant à la recherche et participer à
              ...
              <SimpleCard cardClass="white">
                ...
                <ul className="card__list">
                  ...
                  <li>
                    ...
                    public, gestion des plannings, rédaction de courriers et de
                    compte-rendu).
                  </li>
                  ...
                  <li>
                    ...
                    CHSCT (à la place du médecin avec des missions spécifiques)
                  </li>
                </ul>
              </SimpleCard>
              ...
              <p>
                ...
                pertinent, d’autres acteurs peuvent être mobilisés au service de
                l’entreprise selon les problématiques :
              </p>
