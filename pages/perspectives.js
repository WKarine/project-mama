  ...
  <Layout>
    ...
    <div className="row">
      <div className="col s12 m5 offset-m5 ">
        ...
        <p>
          Santé travail 3.0 recouvre toutes les dimensions de notre métier. Dans
          ce projet global, plusieurs outils sont développés :
        </p>

        <p>
          Pour les entreprises adhérentes, le portail web a été complètement
          revu. Des groupes utilisateurs internes et externes ont pu tester les
          différentes fonctionnalités et améliorer l’outil. Le premier lot s’est
          concentré à améliorer l’expérience utilisateur sur les obligations de
          déclaration mais notre souhait est de proposer une interface
          relationnelle qui va au-delà du volet administratif et comptable et
          mieux identifier tous nos contacts en entreprises. En parallèle
          l’objectif est de mettre en lisibilité aussi nos actions en
          entreprise.
        </p>

        <p>
          Pour les professionnels de santé au travail, le logiciel métier est en
          cours de refonte. Un cahier des charges a été rédigé afin d’adapter
          les outils aux nouvelles pratiques et aux enjeux de traçabilité des
          actions.
        </p>

        <p>
          Pour tous les salariés de PÔLE SANTÉ TRAVAIL, un intranet collaboratif
          a été mis en place pour favoriser la circulation de l’information et
          promouvoir le travail collaboratif. Pour les services de santé au
          travail, PÔLE SANTÉ TRAVAIL a souhaité initier un partenariat unique
          en France avec 15 services de santé au travail pour la création d’une
          base de données en toxicologie qui permettra une meilleure
    ...
    <div className="row">
      <div className="col s12 m5 offset-m2 ">
        ...
        <p>
          La politique de valorisation et de promotion de la santé au travail se
          poursuit. Le point fort de cette année 2016 a été l’organisation du
          salon PRÉVENTICA : pendant 3 jours conférences, ateliers, stand ont
          permis de donner de la lisibilité sur les missions du service de santé
          au travail. Des grands rendez-vous comme le salon des créateurs
          d’entreprises et des TPE « CREER » et les rencontres
          Experts-comptables ont été renouvelés. Dans le cadre de notre
          communication autour du nouvel espace adhérent, des testings
          utilisateurs ont été organisés. Notre participation à la 1ère édition
          du salon des entreprises a été l’occasion de promouvoirce nouvel
          outil. L’assemblée générale 2016 a proposé des ateliers autour de la
          prévention des addictions, du maintien dans l’emploi et du juridique.
          168 supports d’informations ont été réalisés sur l’année.
        </p>
        ...
        <p>
          ...
          indispensable d’adaptation à l’évolution des missions et des métiers
          qui permet le développement des compétences. Un plan de formation
          ambitieux apporte une forte valeur ajoutée dans les prestations
          proposées en réponse aux besoins actuels des entreprises. 6,3 % de la
